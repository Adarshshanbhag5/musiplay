...
const SongInfoModal = ({route, navigation}) => {
  return (
    <ModalWrap navigation={navigation}>
      <View>
        <View style={[globalStyle.flex__row__start, styles.header__container]}>
          <MaterialIcons name="info-outline" color={'#fff'} size={26} />
          <Text style={styles.head__text}>Song info</Text>
        </View>
